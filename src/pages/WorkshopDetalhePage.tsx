...
export function WorkshopDetalhePage() {
  ...
  return (
    <section className="space-y-4">
      ...
      <p><strong>Data:</strong> {new Date(workshop.data_evento).toLocaleDateString('pt-BR')}</p>
      <p><strong>Local:</strong> {workshop.local}</p>
      {episodioRelacionado && <p><strong>Episódio relacionado:</strong> {episodioRelacionado.titulo}</p>}
